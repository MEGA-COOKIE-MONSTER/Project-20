...
function setup(){
    ...
    wallLeft= Bodies.rectangle(5, 300, 20, 600, plane_options)
    World.add(world, wallLeft)
    wallRight= Bodies.rectangle(545, 300, 20,600, plane_options);
    World.add(world, wallRight)
    topWall= Bodies.rectangle(550, 300, 600, 20)
...
function draw(){
  ...
  rect(topWall.position.x, topWall.position.y, 600,20 )
  rect(wallRight.position.x, wallRight.position.y, 20,600)
  rect(wallLeft.position.x, wallLeft.position.y, 20,600)
